...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2020 a las 01:50:17
...
('CROS1248HASQM', 'CROS121255', 'Juan', 'Calle falsa', '449 264 2411', 'pedrojuan@gmail.com', 'hombre', 22, 112414, '', 1);
...
INSERT INTO `candidato_has_habilidad` (`Curp`, `idHabilidad`, `Experiencia`, `calificacion`) VALUES
('CROS1248HASQM', 1, '2 años', 8);
...
ALTER TABLE `resultadocandidato`
  ADD PRIMARY KEY (`Curp`,`idSolicitud`),
