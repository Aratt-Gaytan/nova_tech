...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2020 a las 23:21:23
...
('GAFR020409MASYLSA5', 0, 'tres dias', 0, 1);
...
('GAFR020409MASYLSA5', 0, 0, 'UAA', 1, 0);
...
INSERT INTO `resultadocandidato` (`EstatusProceso`, `Comentarios_area`, `Comentarios_ofertas_salario`, `Comentarios_area_seleccion`, `Estatus`, `idSolicitud`, `Curp`, `id_actitud`, `CoeficienteIntelectual`, `Personalidad`, `Calificacion`, `apto`) VALUES
('', '', '', '', '', 0, 'GAFR020409MASYLSA5', 4, 130, 'evaluacion', 0, 1);
